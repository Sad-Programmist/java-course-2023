...
import edu.hw7.task3_5.CachingPersonDatabaseReadWriteLock;
...
public class CachingPersonDatabaseReadWriteLockTest {

    @Test
    @DisplayName("Параллельное добавление и поиск по имени")
    void parallelAddAndFindByName() throws InterruptedException {
        // given
        CachingPersonDatabaseReadWriteLock database = new CachingPersonDatabaseReadWriteLock();
